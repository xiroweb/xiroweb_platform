(function () {
  ...
  var getCookie = function getCookie() {
    return document.cookie.length && document.cookie.split('; ').find(function (row) {
      return row.startsWith('xiroadminSidebarState=');
    }).split('=')[1];
  };
  ...
  var headerCondensedItems = [].slice.call(headerCondensedItemContainer.querySelectorAll('.header-dd-item')); // let headerTitleWidth = headerTitleArea.getBoundingClientRect().width;

  var headerTitleWidth = 256;
