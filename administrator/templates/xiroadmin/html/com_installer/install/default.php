...
<div class="row">
	<div class="col-12 text-end mb-2">
		<a href="https://www.xiroweb.com/vn/app" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-fw fa-cloud-download"></i> <?php echo Text::_('TPL_XIROADMIN_COM_INSTALLER_LINK_TO_SEARCH_XIROWEB_APP'); ?></a>
		<a href="https://www.xiroweb.com/vn/giao-dien" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-fw fa-cloud-download"></i> <?php echo Text::_('TPL_XIROADMIN_COM_TEMPLATES_TEMPLATE_MORE_LINK'); ?></a>
	</div>
</div>
