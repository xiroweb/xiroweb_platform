    ...
    <form action="index.php" method="post" id="adminForm" class="form-validate">
        ...
        <fieldset id="installStep2" class="j-install-step">
            ...
            <div class="alert alert-info m-2">
                <?php echo Text::_('INSTL_LOGIN_DATA_HELPER_NOTE'); ?>
            </div>
            <div class="j-install-step-form">
                <div class="mb-3">
        ...
        <fieldset id="installStep3" class="j-install-step" >
            ...
            <div class="alert alert-info m-2">
				<?php echo Text::_('INSTL_DATABASE_HELPER_NOTE'); ?>
			</div>
            <div class="j-install-step-form">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="field-note">
						<?php echo Text::_('INSTL_DATABASE_HOST_DESC_NOTE'); ?>
					</div>
                </div>
                <div class="mb-3">
                    <?php echo $this->form->renderField('db_user'); ?>
                    <div class="field-note">
						<?php echo Text::_('INSTL_DATABASE_USER_DESC_NOTE'); ?>
					</div>
                </div>
                <div class="mb-3">
                    <?php echo $this->form->renderField('db_pass'); ?>
                    <div class="field-note">
						<?php echo Text::_('INSTL_DATABASE_PASSWORD_DESC_NOTE'); ?>
					</div>	
                </div>
                <div class="mb-3">
                    <?php echo $this->form->renderField('db_name'); ?>
                    <div class="field-note">
                        <?php echo Text::_('INSTL_DATABASE_NAME_DESC_NOTE'); ?>
                    </div>
                </div>
                <div class="mb-3">
