...
<div class="js-stools" role="search">
	...
	<div class="js-stools-container-bar">
		<div class="btn-toolbar">
			<?php echo $this->sublayout('filterposition', $filters['filter_position']);
			unset($filters['filter_position']);
			?>
	...
	<div class="js-stools-container-filters clearfix<?php echo $filtersActiveClass; ?>">
		...
		<?php echo $this->sublayout('filters', $filters); ?>
		<?php endif; ?>
	</div>
	<?php if ($data['options']['showSelector']) : ?>
	<div class="js-stools-container-selector hidden">
