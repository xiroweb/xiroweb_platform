...
if (ComponentHelper::getParams('com_templates')->get('template_positions_display') && !$clientId) {
	$wa = Factory::getApplication()->getDocument()->getWebAssetManager();
	$wa->disableScript('webcomponent.field-module-order');
	$wa->registerAndUseScript('webcomponent.field-module-order-select-position', 'system/fields/joomla-field-module-order-select-positon.js', ['relative' => true, 'version' => 'auto'], []);
}
